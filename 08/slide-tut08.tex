...
\begin{frame}{Grundlagen zu Prädikatenlogik}
	Prädikatenlogik (PL) \ip \markBlue{erweitert} Aussagenlogik durch Ergänzen von ``Prädikaten'', einer Art von Funktionen, die Wahrheitswerte zurückgeben.
...
\begin{frame}{Bindungsbereich von Quantoren}
	...
	\bp Überschattung ist möglich, durch Quantoren definierte Variablen beziehen sich immer auf den \markBlue{nächsten} Quantor.
	\begin{itemize}
